...
<style type="text/css">
    ...
    .total-part {
        ...
        /* Membuat elemen dalam .total-part tersebar secara merata */
        align-items: center;
    ...
    .head-title {
        position: relative;
        /* Add this to enable absolute positioning */
    }
...
<body>
    ...
    <div class="add-detail mt-10">
        <div class="w-50 float-left mt-10">
            <p class="m-0 pt-2 text-bold w-100">Order Id - <span class="gray-color">{{ ($data['order']->id) }}</span>
            </p>
            <p class="m-0 pt-2 text-bold w-100">Order Date - <span
                    class="gray-color">{{ $data['order']->created_at->format('Y-m-d') }}</span></p>
            <p class="m-0 pt-2 text-bold w-100">Invoice Id - <span
                    class="gray-color">#{{ ($data['order']->invoice_number) }}</span></p>
        </div>
