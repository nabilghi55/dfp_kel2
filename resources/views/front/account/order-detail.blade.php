                    ...
                    <div class="card card-lg mb-5 mt-3">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li class="list-group-item d-flex">
                                    <span>Discount
                                        {{ !empty($data['order']->coupon_code) ? '(' . $data['order']->coupon_code . ')' : '' }}
                                    </span>
                            ...
                            <div class="text-md-right">
                                <div class="float-lg-left mb-lg-0 mb-3">
                                    ...
                                    @elseif ($data['order']->payment_status == '3')
                                        <a href="" class="btn btn-danger text-white btn-icon icon-left"><i
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href =
                                "{{ route('account.orderDetail', ['orderId' => $data['order']->id]) }}";
                        }
                    });
                    console.log(result)
                },
