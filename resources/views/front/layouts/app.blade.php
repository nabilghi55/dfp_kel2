			...
			<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
				<div class="col-lg-4 logo">
					<a href="{{ route('front.home') }}" class="text-decoration-none">
						<span class="h1 text-uppercase text-light bg-dark px-2">DFP</span>
						<span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">KEL2</span>
					</a>
				</div>
					...
					<form action="{{ route('front.shop') }}" method="get">
						...
						<form action="">
							<div class="input-group">
								<input value="{{ Request::get('search') }}" placeholder="Search For Products"
		...
		<div class="container">
			<nav class="navbar navbar-expand-xl" id="navbar">
				<a href="{{ route("front.home") }}" class="text-decoration-none mobile-logo">
					<span class="h2 text-uppercase text-primary bg-dark">DFP</span>
					<span class="h2 text-uppercase text-white px-2">KEL2</span>
				</a>
