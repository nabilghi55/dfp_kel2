        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3">
                        <h1 class="display-4 text-white mb-3">DFP KEL 2</h1>
                        <p class="mx-md-5 px-5">Beli hp baru atau second semua nya ready. Laptop bekas dan baru ready,
                            dengan harga termurah se Indonesia</p>
